...
- [Sim trading goto & rolling cache](sim-trading-goto-and-cache.md) — goto reloads outside cache bounds either direction; stale cache via recorded load resolution; axis needs tickMarkFormatter for ET.
