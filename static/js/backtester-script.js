...
function applyOptionsConfig(rawConfig) {
    ...
    config.detectionBarSize = rawConfig.detectionBarSize || (rawConfig.detection_bar_size != null ? String(rawConfig.detection_bar_size) : '');
    ...
    setTimeout(() => {
        ...
        if (document.getElementById('detectionBars') && config.detectionBarSize) {
            document.getElementById('detectionBars').value = config.detectionBarSize;
        }
