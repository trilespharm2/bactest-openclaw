        ...
        if (!hasContent) {
            ...
            try {
                ...
                if (pageName === 'stockBacktester') {
                    ...
                    scriptName = '/static/js/stock-backtester-script.js?v=6';
                }
                ...
                if (pageName === 'bot') {
                    scriptName = '/static/js/bot-script.js?v=31';
                }
                ...
                if (pageName === 'optionsResultDetail' || pageName === 'stockResultDetail') {
                    scriptName = '/static/js/backtest-result-detail-script.js?v=3';
            ...
            if (inlineScriptPages.includes(pageName)) {
                ...
                if (pageName === 'backtester') {
                    scriptName = '/static/js/backtester-script.js?v=4';
                }
                if (pageName === 'stockBacktester') {
