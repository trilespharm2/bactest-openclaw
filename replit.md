...
-   **Strategy Guide**: A comprehensive reference page with 5 tabs: (1) Strategy Guide covering 22 options strategies with SVG payoff diagrams, (2) Options Backtester Reference with all 14 form sections, (3) Options Results Reference with SVG mock visualizations, 39-column trade log breakdown, and decision tree events, (4) Stock Backtester Reference with all 7 form sections (name, symbol/dates, entry conditions, entry criteria, exit criteria, signal-based exits, advanced), (5) Stock Results Reference with equity curve, 10-column trade log, and decision tree. All tabs support search filtering.
