...
-   **Strategy Guide**: A comprehensive reference page with 3 tabs: (1) Strategy Guide covering 22 options strategies with SVG payoff diagrams, (2) Backtester Reference with all 14 form sections, and (3) Results Reference with screenshots, all 8 performance metrics, complete 39-column trade log CSV breakdown, and decision tree event types. All tabs support search filtering.
