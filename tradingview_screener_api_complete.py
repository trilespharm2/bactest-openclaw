...
class TradingViewScreenerAPI:
    ...
    GROWTH_PERIODS = ["TTM YoY", "Annual YoY"]
    GROWTH_PERIOD_MAP = {
        "TTM YoY": "yoy_growth_ttm", "Annual YoY": "yoy_growth_fy"
    }
    ...
    def _setup_filter_definitions(self):
        ...
        self.filters = {
            "Security Info": [
                ...
                {"id": "earnings_release_date", "name": "Upcoming Earnings Date", "type": "date_preset", "column": "earnings_release_next_date", "options": self.UPCOMING_EARNINGS_OPTIONS},
                {"id": "earnings_release_date_recent", "name": "Recent Earnings Date", "type": "date_preset", "column": "earnings_release_date", "options": self.RECENT_EARNINGS_OPTIONS},
            ...
            "Technicals": [
                ...
                {"id": "donch", "name": "Donchian Channels", "type": "fixed_channel", "column": "DonchCh20", "fixed_period": 20, "channels": ["Upper", "Middle", "Lower"], "timeframes": self.TIMEFRAMES, "default_timeframe": "1 day", "unit": "USD"},
                {"id": "ichimoku", "name": "Ichimoku Cloud", "type": "ichimoku", "column": "Ichimoku", "input_options": self.ICHIMOKU_INPUTS, "default_input": "9,26,52,26", "plot_options": ["Conversion Line", "Base Line", "Leading Span A", "Leading Span B"], "default_plot": "Base Line", "timeframes": self.TIMEFRAMES, "default_timeframe": "1 day", "unit": "USD"},
                ...
                {"id": "cmf", "name": "Chaikin Money Flow", "type": "fixed_period", "column": "ChaikinMoneyFlow", "fixed_period": 20, "timeframes": self.TIMEFRAMES, "default_timeframe": "1 day", "unit": "numeric"},
                {"id": "mfi", "name": "Money Flow Index", "type": "fixed_period", "column": "MoneyFlow", "fixed_period": 14, "timeframes": self.TIMEFRAMES, "default_timeframe": "1 day", "unit": "numeric"},
                ...
                {"id": "di_plus", "name": "Directional Movement Index +DI", "type": "fixed_period", "column": "ADX+DI", "fixed_period": 14, "timeframes": self.TIMEFRAMES, "default_timeframe": "1 day", "unit": "numeric"},
                {"id": "di_minus", "name": "Directional Movement Index -DI", "type": "fixed_period", "column": "ADX-DI", "fixed_period": 14, "timeframes": self.TIMEFRAMES, "default_timeframe": "1 day", "unit": "numeric"},
            ...
            "Valuation & Growth": [
                ...
                {"id": "revenue_growth", "name": "Revenue Growth %", "type": "growth", "column": "total_revenue", "growth_periods": self.GROWTH_PERIODS, "default_growth_period": "TTM YoY", "unit": "%"},
                {"id": "gross_profit_growth", "name": "Gross Profit Growth %", "type": "growth", "column": "gross_profit", "growth_periods": self.GROWTH_PERIODS, "default_growth_period": "TTM YoY", "unit": "%"},
                {"id": "net_income_growth", "name": "Net Income Growth %", "type": "growth", "column": "net_income", "growth_periods": self.GROWTH_PERIODS, "default_growth_period": "TTM YoY", "unit": "%"},
                {"id": "ebitda_growth", "name": "EBITDA Growth %", "type": "growth", "column": "ebitda", "growth_periods": self.GROWTH_PERIODS, "default_growth_period": "TTM YoY", "unit": "%"},
                {"id": "eps_growth", "name": "EPS Diluted Growth %", "type": "growth", "column": "earnings_per_share_diluted", "growth_periods": self.GROWTH_PERIODS, "default_growth_period": "TTM YoY", "unit": "%"},
                {"id": "fcf_growth", "name": "Free Cash Flow Growth %", "type": "growth", "column": "free_cash_flow", "growth_periods": self.GROWTH_PERIODS, "default_growth_period": "TTM YoY", "unit": "%"},
                {"id": "capex_growth", "name": "Capital Expenditures Growth %", "type": "growth", "column": "capital_expenditures", "growth_periods": self.GROWTH_PERIODS, "default_growth_period": "TTM YoY", "unit": "%"},
    ...
    def _build_column_name(self, filter_def: Dict, config: Dict) -> str:
        ...
        # Fixed channel (Donchian)
        elif filter_type == "fixed_channel":
            channel = config.get("channel", "Upper")
            return f"{base_col}.{channel}{tf_suffix}"
        ...
        # Growth period filters
            ...
            suffix = self.GROWTH_PERIOD_MAP.get(growth_period, "yoy_growth_ttm")
            return f"{base_col}_{suffix}"
        
        # Locked growth
        elif filter_type == "locked_growth":
            growth_period = filter_def.get("locked_growth_period", "Annual YoY")
            suffix = self.GROWTH_PERIOD_MAP.get(growth_period, "yoy_growth_fy")
            return f"{base_col}_{suffix}"
